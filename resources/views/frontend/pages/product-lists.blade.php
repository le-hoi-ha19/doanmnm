					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Dánh sách sản phẩm</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-9 col-md-8 col-12">
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="category" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='category') selected @endif>Loại mặt hàng</option>
							...
							<div class="row">
								@if(count($products))
									...
									@endforeach
								@else
									<h4 class="text-warning" style="margin:100px auto;">Không có sản phẩm nào cả</h4>
								@endif
							</div>
							 <div class="row">
